...
import { Widget as WidgetType, addResponseMessage, setQuickButtons, toggleMsgLoader, addLinkSnippet, toggleInputDisabled, toggleForcedScreenRecorder, toggleWidget, togglePasteEnabled, setMinCharLimit } from '../index';
